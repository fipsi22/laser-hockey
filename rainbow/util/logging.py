...
def save_run_config(config, save_dir):
    ...
    # Convert non-serializable objects (like spaces) to strings
...
class TrainingTracker:
    ...
    def log_episode(self, episode_data):
        ...
        # Save to CSV every episode so we don't lose data if the cluster crashes
    ...
    def save_summary(self):
        ...
        # Logic to calculate avg win rate of last 100 games, etc.